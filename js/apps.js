...
const sttaddr = "0x5345a9bf7ccc80a72df2f60d03848d59a4947bed";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x5345a9bf7ccc80a72df2f60d03848d59a4947bed";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://oilswap.net?ref=' + document.getElementById('refaddress').value;
        }
    }
}
